...
def convert() :
  ...
  plot_options.SetPlotOutlineMode(False)
  # Export, Rename
  ...
  npth_drill_raw_filepath = os.path.join(pcb_dirpath, "{}-NPTH.drl".format(board_basename))
  npth_drill_filepath = os.path.join(pcb_dirpath, "{}-NPTH.TXT".format(board_basename))
  if os.path.isfile(npth_drill_raw_filepath):
    shutil.move(npth_drill_raw_filepath, npth_drill_filepath)
  ...
  with zipfile.ZipFile(pcb_zipfilepath, 'w') as zip_f :
    ...
    if os.path.isfile(npth_drill_filepath):
      npth_drill_filename = os.path.join(pcb_dirname, "{}-NPTH.TXT".format(board_basename))
      zip_f.write(npth_drill_filepath, npth_drill_filename)
