...
\title{RoboCup Rescue \TDPvenue Team Description Material \\
 TUPAC}
...
In order to clear the Centor Test, the size of the Robot shuld be within 25cm squares.
Actually, the Robot can be cleard the Center Test even if the length of Robot is longer than 25cm.
As reference, the length of our Robot is approximately 30cm, and it can clear the Center Test without problem line a stuck.
