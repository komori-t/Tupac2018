...
\hspace{10pt} Team Leader: \hfill Tada Yusuke\\
% \hspace{10pt} Team URL: \hfill % \url{https://moon.edu}\\
\hspace{10pt} Team Record: \hfill 3rd Place of RoboCup Rescue RMRC \\
\hfill 2017 in Nagoya Japan\\
\vspace{5pt}
...
Also, for the newly participating participants, the important thikgs in the competition are explained in Section \ref{sec:for_participants}.
