...
#define i2c_write(a, b, c, d) tegra_i2c_write(a, b, c, d)
#define i2c_read(a, b, c, d)  tegra_i2c_read(a, b, c, d)
#define delay_ms  tegra_delay_ms
#define get_ms    tegra_get_clock_ms
